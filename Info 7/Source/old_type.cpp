...
char old_type::type_board::get_piece(int i, const int j) const // i = row, j = column
{
...
// Get the turn
char old_type::type_board::get_turn() const {return fen_other[0];}

// Get the castling rights for specified color and type
string old_type::type_board::get_castling(const char color) const
...
string old_type::type_board::get_en_passant() const
{
...
int old_type::type_board::get_halfmove()
{
...
int old_type::type_board::get_fullmove()
{
...
// Get the FEN string
string old_type::type_board::get_fen() const
{
...
void old_type::type_board::set_piece(int i, const int j, const char piece)
{
    // Check if the position is valid
    if (i < 0 || i > 7 || j < 0 || j > 7) {return;}
...
// Set the turn
void old_type::type_board::set_turn(const char turn) {fen_other[0] = turn;}

// Set the castling rights for specified color and type
void old_type::type_board::set_castling(const char castling, const bool value)
...
void old_type::type_board::set_en_passant(const string en_passant)
{
...
void old_type::type_board::set_halfmove(const int halfmove)
{
...
void old_type::type_board::set_fullmove(const int fullmove)
{
...
// Set the FEN
void old_type::type_board::set_fen(const string fen)
{
