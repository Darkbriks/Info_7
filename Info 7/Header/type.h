...
struct type_history
{
    type_maillon* board_history;
    type_maillon* move_history;
...
struct type_game
{
    ...
    type_game(type_board board, type_history pile_Historique); // Initialise le jeu avec un plateau et une pile d'historique donnés.
    type_game(type_board board, type_mask mask, type_history pile_Historique); // Initialise le jeu avec un plateau, un masque et une pile d'historique donnés.
